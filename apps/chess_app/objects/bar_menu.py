...
class BarMenu:
    def __init__(self, root):
        ...
        # Create a menu
        self.game_menu = Menu(self.menu_bar)
        ...
        if confirm:
            ...
            if game_mode == 'guest':
                with open(os.getcwd() + '\\apps\\chess_app\\all_settings\\guest\\default_game_settings.csv', 'w') as f:
                    f.write('Game_difficulty, time, game_mode, player_piece_color, opponent_piece_color, board_color\n')
...
class GeneralSettings(ttk.Frame):
    def __init__(self, parent):
        ...
        # novice button
        novice = Radiobutton(difficulty_frame,
                             text="Novice",
        ...
        # intermediate button
        intermediate = Radiobutton(difficulty_frame,
                                   text="Intermediate",
                                   variable=self.difficulty_var,
                                   value=2,
                                   command=self.get_difficulty)
        ...
        # expert button
        expert = Radiobutton(difficulty_frame,
                             text="Expert",
                             variable=self.difficulty_var,
                             value=3,
                             command=self.get_difficulty)
